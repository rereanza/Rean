...
function renderFromConfig() {
 ...
 border:1px solid rgba(255,20,20,0.10);
 border-radius:16px;
 overflow:hidden;
 ...
 background:linear-gradient(135deg,#ff1414,#ff1414);
 ...
 color:#ff1414;font-size:22px;flex-shrink:0;
 ...
 <div style="background:rgba(24,20,38,0.85);border:1px solid rgba(255,20,20,0.12);
 ...
 ${rankStyle[i] || 'background:rgba(255,20,20,0.1);color:#ff1414;border:1px solid rgba(255,20,20,0.2);'}">
 ${i+1}
 </span>
 ...
 color:#ff1414;font-size:13px;">${d.jumlah}</span>
 </div>
 `).join('')}
 </div>
 </div>`;
...
;(function() {
 ...
 <div style="background:rgba(24,20,38,0.85);border:1px solid rgba(255,20,20,0.10);border-radius:14px;padding:20px 18px;text-align:left;backdrop-filter:blur(12px);">
 <div style="font-family:'JetBrains Mono',monospace;font-size:10px;color:#ff1414;letter-spacing:0.10em;font-weight:700;margin-bottom:8px;">${s.label.toUpperCase()}</div>
...
;(function() {
 ...
 <img src="${t.imagePath}" style="max-width:100%;border-radius:14px;border:1px solid rgba(255,20,20,0.15);" loading="lazy">
 ...
 <div style="background:rgba(24,20,38,0.9);border:1px solid rgba(255,20,20,0.12);border-radius:20px;padding:32px 24px;text-align:center;backdrop-filter:blur(14px);">
 <div style="width:64px;height:64px;border-radius:50%;margin:0 auto 16px;background:linear-gradient(135deg,#ff1414,#ff1414);display:flex;align-items:center;justify-content:center;font-family:'JetBrains Mono',monospace;font-weight:800;font-size:18px;color:#000;">
 ...
 `<button class="testi-dot${i===0?' active':''}" data-index="${i}" style="width:8px;height:8px;border-radius:50%;background:${i===0?'#ff1414':'#4b5563'};border:none;cursor:pointer;padding:0;"></button>`
 ).join('');
 }
 ...
 d.style.background = active ? '#ff1414' : '#4b5563';
 });
 };
...
;(function() {
 ...
 <div style="position:relative;background:rgba(24,20,38,0.85);border:1px solid rgba(255,20,20,0.12);border-radius:20px;padding:32px 24px 24px;text-align:center;backdrop-filter:blur(14px);transition:transform 0.25s ease,border-color 0.25s ease;"
 onmouseover="this.style.transform='translateY(-4px)';this.style.borderColor='rgba(255,20,20,0.35)'"
 onmouseout="this.style.transform='';this.style.borderColor='rgba(255,20,20,0.12)'">
 ${o.emoji ? `<span style="position:absolute;top:16px;right:16px;font-size:22px;">${o.emoji}</span>` : ''}
 <div style="width:90px;height:90px;border-radius:50%;background:linear-gradient(135deg,#ff1414,#ff1414);padding:2.5px;margin:0 auto 16px;box-shadow:0 0 24px rgba(255,20,20,0.2);">
 ...
 <span style="display:inline-block;background:rgba(255,20,20,0.10);color:#ff1414;border:1px solid rgba(255,20,20,0.25);padding:4px 14px;border-radius:20px;font-size:11px;font-weight:700;font-family:'JetBrains Mono',monospace;letter-spacing:0.10em;margin-bottom:10px;">${o.title || o.peran}</span>
 <h3 style="font-size:18px;font-weight:700;color:#f2eef8;margin:0 0 4px;font-family:'JetBrains Mono',monospace;">
 ${o.nama} ${o.verified ? '<span style="color:#ff1414;font-size:14px;">✓</span>' : ''}
 </h3>
 <p style="font-size:12px;color:#a89fb8;margin:0 0 16px;">${o.peran}</p>
 <a href="${o.linkChat}" target="_blank" style="display:block;padding:9px;border-radius:10px;border:1px solid rgba(255,20,20,0.3);color:#ff1414;font-family:'JetBrains Mono',monospace;font-size:11px;font-weight:700;letter-spacing:0.06em;text-decoration:none;transition:background 0.2s;"
 onmouseover="this.style.background='rgba(255,20,20,0.08)'" onmouseout="this.style.background=''">
 Chat
 </a>
 </div>
 `).join('');
...
;(function() {
 ...
 ${s.accent ? 'background:rgba(255,20,20,0.06);border:1px solid rgba(255,20,20,0.3);' : 'background:rgba(24,20,38,0.85);border:1px solid rgba(255,20,20,0.10);'}"
 onmouseover="this.style.transform='translateY(-4px)';this.style.borderColor='rgba(255,20,20,0.35)'"
 onmouseout="this.style.transform='';this.style.borderColor='${s.accent ? 'rgba(255,20,20,0.3)' : 'rgba(255,20,20,0.10)'}'">
 <div style="width:40px;height:40px;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:20px;background:rgba(255,20,20,0.08);border:1px solid rgba(255,20,20,0.2);">${s.icon}</div>
 <div>
 ...
 ${s.accent ? 'color:#000;background:#ff1414;padding:8px 16px;border-radius:10px;' : 'color:#ff1414;'}">
 ${s.label} →
 </a>
 </div>
 `).join('');
...
;(function() {
 ...
 <div style="background:rgba(24,20,38,0.85);border:1px solid rgba(255,20,20,0.10);border-radius:16px;padding:20px;backdrop-filter:blur(12px);transition:border-color 0.2s;display:flex;align-items:center;gap:16px;"
 onmouseover="this.style.borderColor='rgba(255,20,20,0.3)'" onmouseout="this.style.borderColor='rgba(255,20,20,0.10)'">
 ...
 style="flex-shrink:0;padding:10px 18px;border-radius:10px;border:1px solid rgba(255,20,20,0.3);background:rgba(255,20,20,0.08);color:#ff1414;font-family:'JetBrains Mono',monospace;font-size:11px;font-weight:700;cursor:pointer;letter-spacing:0.04em;white-space:nowrap;transition:background 0.2s;"
 onmouseover="this.style.background='#ff1414';this.style.color='#000'"
 onmouseout="this.style.background='rgba(255,20,20,0.08)';this.style.color='#ff1414'">
 Buka →
 </button>
 </div>
 `).join('');
...
;(function() {
 ...
 ${p.highlight
 ? 'background:linear-gradient(160deg,rgba(255,20,20,0.10),rgba(255,20,20,0.04));border:1.5px solid rgba(255,20,20,0.5);box-shadow:0 0 40px rgba(255,20,20,0.12);'
 ...
 ${p.badge ? `<span style="position:absolute;top:20px;right:20px;background:#ff1414;color:#000;font-family:'JetBrains Mono',monospace;font-size:9px;font-weight:800;padding:3px 10px;border-radius:20px;letter-spacing:0.06em;">${p.badge}</span>` : ''}
 ...
 ${p.highlight ? 'background:#ff1414;color:#000;' : 'background:rgba(255,255,255,0.08);color:#f2eef8;'}"
 ...
 <svg width="16" height="16" fill="none" stroke="${p.highlight ? '#ff1414' : '#a89fb8'}" stroke-width="2.4" viewBox="0 0 24 24" style="flex-shrink:0;"><polyline points="20 6 9 17 4 12"/></svg>
 ${f}
 </li>`).join('')}
 </ul>
 </div>`;
...
function toggleFaq(btn) {
 ...
 document.querySelectorAll('.faq-tw-item').forEach(it => { it.style.borderColor = 'rgba(255,20,20,0.10)'; });

 if (!isOpen) {
 answer.style.maxHeight = answer.scrollHeight + 'px';
 icon.textContent = '×';
 icon.style.transform = 'rotate(0deg)';
 item.style.borderColor = 'rgba(255,20,20,0.4)';
 item.style.boxShadow = '0 0 20px rgba(255,20,20,0.06)';
 } else {
...
function copyPay(nomor, btn) {
 ...
 btn.style.color = '#ff1414';
 btn.style.borderColor = 'rgba(255,20,20,0.4)';
 setTimeout(() => {
...
function submitTesti() {
 ...
 if (status) { status.textContent = '✓ Ulasan berhasil dikirim. Terima kasih!'; status.style.color='#ff1414'; status.style.display='block'; setTimeout(function(){ status.style.display='none'; }, 3000); }
